...
<html>
    <head>
		...
		<link rel="stylesheet" type="text/css" href="lib/pr.css" />
...
IF( count($TMPPRO)>1 )
{
	...
	{
		IF( $P_MIN>$_GET['PP_'.$TMPPRO[$i]] )
		{
			$P_MIN=$_GET['PP_'.$TMPPRO[$i]];
			$WIN=$TMPPRO[$i];
		}
	}
...
echo '<div align="center" class="math">
	 ...
	 <div class="logo" align="center">
			...
			<div class="header"><label id="lbl_key_back" onclick="history.back();"><span></span></label>الگوریتم زمانبندی اولویت پردازشگر به زبان PHP</div>
